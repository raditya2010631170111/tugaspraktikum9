            ...
            SizedBox(height: MediaQuery.of(context).size.height,
              child: Column(
                children: [
                  Wrap(
                    children: [
                      ClipPath(clipper: WaveClipperTwo(),
                        child: Container(color: Colors.pink.shade300,
                          height: MediaQuery.of(context).size.height / 2.5,
                          child: const Center(child: Text('Wave Clipper Two',
                  ...
                  Padding(padding: const EdgeInsets.all(24),
                    child: Form(autovalidateMode: AutovalidateMode.always,
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Welcome.', style: Theme.of(context).textTheme.headline4), const SizedBox(height: 10),
                          Text('Login to your account below or signup for an amazing experience', style: Theme.of(context).textTheme.subtitle1,),
                          SizedBox(height: kTabLabelPadding.left),
                          TextFormField(cursorColor: Colors.pink.shade300,
                          ...
                          SizedBox(width: MediaQuery.of(context).size.width,
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                ...
                                // REGISTER
                                Expanded(child: TextButton(onPressed: () {}, child: const Text('Register'),),),
                              ],
                            ),
                          ),
                        ],
                  ...
                  const Spacer(), const Text('App Name v1.0.0'), const SizedBox(height: 20),
                ],
              ),
            ),
          ],
